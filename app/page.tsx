...
export default function Home() {
  ...
  const modules = [
    {
      ...
      title: 'Business',
      fullTitle: 'Business Plan & Investment',
    ...
    },
    {
      ...
      title: 'IPR',
      fullTitle: 'IPR Commercialization',
    ...
    },
    {
      ...
      title: 'Visa',
      fullTitle: 'International Visa & Residency',
  ...
  const quickLinks = [
    {
      type: 'Guide',
      title: 'Getting Started with Japa',
      icon: <ArrowRight className="w-6 h-6" />,
    },
    {
      type: 'Video',
      title: 'How to Choose Your Module',
      icon: <Play className="w-6 h-6" />,
    },
    {
      type: 'Webinar',
      title: 'Income Strategies & Tips',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="home"
        className="pt-24 pb-16 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 relative overflow-hidden"
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                ...
                Start earning 3x Nigeria's minimum wage while building your international
                career.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-700 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition transform hover:scale-105 flex items-center"
                >
                  Start Your Journey
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition duration-500">
                <div className="bg-gradient-to-br from-green-100 to-blue-100 rounded-xl p-6 mb-6">
                  ...
                  <p className="text-gray-600">
                    Choose from 9 specialized modules designed for your unique skills and
                    goals
                  </p>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide a holistic solution to Africa's youth employment crisis through
            ...
            {[
              {
                ...
                description:
                  "Start earning 3x Nigeria's minimum wage while still a student through our data entry and remote work programs",
              ...
              },
              {
                ...
                description:
                  'Access international visa support, digital nomad pathways, and citizenship opportunities in 25+ countries',
              ...
              },
              {
                ...
                description:
                  'Build and own a sustainable income stream generating $40,000+ annually before you even graduate',
                color: 'from-purple-500 to-pink-500',
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 hover:shadow-2xl transition transform hover:-translate-y-2"
              >
                <div
                  className={`bg-gradient-to-br ${item.color} w-16 h-16 rounded-xl flex items-center justify-center mb-6 text-white`}
                >
                  {item.icon}
                </div>
      ...
      <section id="resources" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Learn how to maximize your opportunities with our comprehensive guides and
              videos
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {quickLinks.map((link, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 hover:shadow-xl transition cursor-pointer group"
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <span className="text-xs font-semibold text-green-600 mb-2 block">
                      {link.type}
                    </span>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white text-opacity-90 mb-8 leading-relaxed">
              Take the eligibility test today and join thousands of Africans building their
              future through global opportunities
            </p>
            ...
            <button
              onClick={handleApplyClick}
              className="bg-white text-green-700 px-12 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition transform hover:scale-105"
            >
              Take Eligibility Test - $15
            </button>
            <p className="text-white text-opacity-75 text-sm mt-4">
              Non-refundable • Reviewed in 4-5 working days
            </p>
          </div>
        </div>
      </section>
